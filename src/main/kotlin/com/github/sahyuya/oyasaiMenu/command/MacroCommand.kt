        ...
        when {
            ...
            args.size >= 3 && args[1].toIntOrNull() != null -> {
                ...
                if (plugin.macroManager.getMacro(player.uniqueId, macroId) == null) {
                    player.sendMessage(c("&cマクロ '&e$macroId&c' が見つかりません。")); return true
                }
                if (value.equals("remove", ignoreCase = true)) {
                    ...
                    val err = plugin.macroManager.setCommandAtIndex(player.uniqueId, macroId, index, value, player)
                    if (err != null) player.sendMessage(c("&c$err"))
            ...
            args.size == 2 ->
                player.sendMessage(c("&7使い方: &f/macro &e<id> &b<番号> &f<コマンド>"))
