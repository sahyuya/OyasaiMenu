...
object NavBar {
    ...
    val entries = listOf(
        ...
        NavEntry(47, Material.ORANGE_CONCRETE_POWDER, "&6一括売却",           "sell_menu"),
        NavEntry(48, Material.YELLOW_CONCRETE_POWDER, "&eサーバーショップ",   "shop_index"),
        ...
        NavEntry(52, Material.PURPLE_CONCRETE_POWDER, "&5マクロ",             "macro_menu"),
